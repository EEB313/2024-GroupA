...
```{r}
preds <- predict(lmmodel, newdata = new_data, type = "response")
...
AIC(lmmodel2)
```
Introducing precipitation as a covariate actually increases the AIC, so this model is not a better fit to the data.
Thus, we will not be including precipitation in our models going forward.
